...
name: no-tropes
description: >-
  Detect and eliminate common AI writing tropes from generated text. Use when
  writing or revising prose, documentation, READMEs, commit messages, PR
  descriptions, blog posts, comments, or any non-code text output. Automatically
  applied as a self-revision pass (tropes.fyi).
---
...
2. Flag any trope matches from the reference
3. Rewrite flagged passages using plain, direct language
4. Prefer simple verbs ("is" over "serves as"), concrete nouns, and varied sentence structure
5. Cut filler transitions ("It's worth noting", "Importantly", "Interestingly")
6. If you catch yourself writing the same structural pattern 3+ times, break the pattern
